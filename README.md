...
图片[2]-超详细的V免签支付系统搭建图文教程-A17资源网
4、设置默认文档，将index.html放在第一行并保存（这里改完顺序点击添加就是保存）

图片[3]-超详细的V免签支付系统搭建图文教程-A17资源网
5、打开网站路径/config/database.php ，设置好你的mysql账号密码并保存

图片[4]-超详细的V免签支付系统搭建图文教程-A17资源网
6、导入数据库文件vmq.sql到服务器里

图片[5]-超详细的V免签支付系统搭建图文教程-A17资源网
7、至此网站搭建完毕，请访问后自行修改配置信息！默认后台账号和密码均为admin

前台演示图

图片[6]-超详细的V免签支付系统搭建图文教程-A17资源网
后台演示图

图片[7]-超详细的V免签支付系统搭建图文教程-A17资源网
图片[8]-超详细的V免签支付系统搭建图文教程-A17资源网
图片[9]-超详细的V免签支付系统搭建图文教程-A17资源网
